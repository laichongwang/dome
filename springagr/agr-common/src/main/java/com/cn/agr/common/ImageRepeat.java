...
public class ImageRepeat {
    ...
    public static String[][] getPX(String args) {
        ...
        int minx = bi.getMinX();
        int miny = bi.getMinY();
        System.out.println("imageType:" + getImageFormat(file));
    ...
    public static void main(String[] args) {
        ...
        // ImageRepeat.compareImage("L:\\image\\a.jpeg", "L:\\image\\b.jpg");
        ImageRepeat.getImageFormat(new File("L:\\image\\a.jpeg"));
    }
